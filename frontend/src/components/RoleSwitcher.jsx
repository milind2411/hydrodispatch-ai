  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center gap-2.5 px-3 py-1.5 rounded-xl bg-slate-900/90 hover:bg-slate-800 border border-slate-700/80 transition group shadow-sm"
        title="Switch Operator Profile & Clearance Level"
      >
        <div className={`h-6 w-6 rounded-lg ${currentPersona.avatarBg} text-black font-extrabold text-[11px] flex items-center justify-center shrink-0`}>
      ...
      {isModalOpen && createPortal(
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in">
          <div className="w-full max-w-2xl bg-[#090d16] border border-slate-800 rounded-3xl p-6 shadow-2xl relative overflow-hidden">
            {/* Modal Header */}
                ...
                return (
                  <div
                    ...
                    className={`rounded-2xl p-4 border transition cursor-pointer flex flex-col justify-between group relative ${
                      isSelected
                        ? `${persona.accentBg} ${persona.accentBorder} shadow-lg shadow-cyan-500/5 ring-1 ring-cyan-500/30`
                  ...
                  >
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        <div className={`h-8 w-8 rounded-xl ${persona.avatarBg} text-black font-extrabold flex items-center justify-center`}>
                    ...
                    <div className="mt-4 pt-3 border-t border-slate-800/80 space-y-1 text-[10px]">
